...
from Flow_Distributor import Channel1, Channel2, Channel3, Channel4
...
Channel1 = ttk.Button(frm, text="Channel 1", command=Channel1.opencloseValve)
Channel2 = ttk.Button(frm, text="Channel 2", command=Channel2.opencloseValve)
Channel3 = ttk.Button(frm, text="Channel 3", command=Channel3.opencloseValve)
Channel4 = ttk.Button(frm, text="Channel 4", command=Channel4.opencloseValve)
...
StopDataExtraction.pack(side=LEFT)
BeginMotor.pack(side=LEFT)
StopMotor.pack(side=LEFT)

Channel1.pack(side=LEFT)
Channel2.pack(side=LEFT)
Channel4.pack(side=RIGHT)
Channel3.pack(side=RIGHT)
